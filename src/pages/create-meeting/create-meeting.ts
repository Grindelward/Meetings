...
export class CreateMeetingPage {
  ...
  constructor(public afAuth: AngularFireAuth, public navCtrl: NavController, public navParams: NavParams, private modalCtrl: ModalController, public angFire: AngularFireDatabase) {    this.meeting.members = []; // place for members must be defined as array at begins
