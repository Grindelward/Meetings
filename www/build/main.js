...
var CreateMeetingPage = (function () {
    ...
    CreateMeetingPage.prototype.confirmMeeting = function (meeting) {
        ...
        this.calendar.createEvent(meeting.topic, meeting.address, meeting.description, new Date(meeting.date), new Date(meeting.date));
